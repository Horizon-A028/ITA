...
- Connectar BigQuery a un Data Lake corporatiu (GCS) utilitzant codi SQL (DDL).
- Diferenciar entre Taules Externes i Natives i el seu impacte en els costos.
- Utilitzar IA Generativa per accelerar la creació de codi.
- Realitzar processos de neteja i unificació de dades robustes (SAFE_CAST).
...
Recorda revisar les millors pràctiques abans de fer el lliurament.

 [![icona enllaç](https://itacademy.barcelonactiva.cat/pluginfile.php/34634/mod_assign/intro/enlla%C3%A7.png) Millors pràctiques](https://itacademy.barcelonactiva.cat/mod/page/view.php?id=15473)
