...
| `transaction`                                                                                                                                           | `company`                                                                                                |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| - Es la tabla de hechos central del esquema estrella, ya que enlaza tablas de dimensión con sus FK.<br>- Cada fila representa una transacción monetaria | - Es una tabla de dimensión, ya que tiene datos varios de la empresa que representa, y no tiene FK.<br>- |
